    ...
    (function(global, factory) {
      ...
      jQuery7.fn = jQuery7.prototype = {
        ...
        map: function(callback) {
          return this.pushStack(jQuery7.map(this, function(elem, i) {
        ...
        even: function() {
          return this.pushStack(jQuery7.grep(this, function(_elem, i) {
            return (i + 1) % 2;
          }));
        },
        odd: function() {
      ...
      (function() {
        var i, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative, document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando = jQuery7.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
          if (a === b) {
            hasDuplicate = true;
          }
          return 0;
      ...
      function winnow(elements, qualifier, not) {
        if (isFunction(qualifier)) {
          return jQuery7.grep(elements, function(elem, i) {
        ...
        find: function(selector) {
          ...
          if (typeof selector !== "string") {
            return this.pushStack(jQuery7(selector).filter(function() {
              for (i = 0; i < len; i++) {
                if (jQuery7.contains(self[i], this)) {
                  return true;
                }
              }
            }));
          ...
          ret = this.pushStack([]);
          for (i = 0; i < len; i++) {
            jQuery7.find(selector, self[i], ret);
          }
      ...
      jQuery7.fn.extend({
        has: function(target) {
          ...
          return this.filter(function() {
            var i = 0;
            for (; i < l; i++) {
              if (jQuery7.contains(this, targets[i])) {
                return true;
              }
            }
          });
        ...
        closest: function(selectors, context) {
          var cur, i = 0, l = this.length, matched = [], targets = typeof selectors !== "string" && jQuery7(selectors);
      ...
      jQuery7.extend({
        Deferred: function(func) {
          ...
          jQuery7.each(tuples, function(i, tuple) {
        ...
        when: function(singleValue) {
          var remaining = arguments.length, i = remaining, resolveContexts = Array(i), resolveValues = slice.call(arguments), primary = jQuery7.Deferred(), updateFunc = function(i2) {
      ...
      jQuery7.fn.extend({
        ...
        promise: function(type, obj) {
          var tmp, count = 1, defer = jQuery7.Deferred(), elements = this, i = this.length, resolve = function() {
            if (!--count) {
      ...
      jQuery7.event = {
        ...
        dispatch: function(nativeEvent) {
          var i, j, ret, matched, handleObj, handlerQueue, args = new Array(arguments.length), event = jQuery7.event.fix(nativeEvent), handlers = (dataPriv.get(this, "events") || /* @__PURE__ */ Object.create(null))[event.type] || [], special = jQuery7.event.special[event.type] || {};
          args[0] = event;
          ...
          if (events) {
            ...
            for (type in events) {
              for (i = 0, l = events[type].length; i < l; i++) {
                jQuery7.event.add(dest, type, events[type][i]);
              }
            }
          }
        }
      ...
      function remove(elem, selector, keepData) {
        var node, nodes = selector ? jQuery7.filter(selector, elem) : elem, i = 0;
      ...
      jQuery7.extend({
        ...
        cleanData: function(elems) {
          var data, elem, type, special = jQuery7.event.special, i = 0;
      ...
      jQuery7.each({
        ...
        jQuery7.fn[name] = function(selector) {
          var elems, ret = [], insert = jQuery7(selector), last = insert.length - 1, i = 0;
          for (; i <= last; i++) {
            elems = i === last ? this : this.clone(true);
            jQuery7(insert[i])[original](elems);
      ...
      function boxModelAdjustment(elem, dimension, box, isBorderBox, styles, computedVal) {
        ...
        for (; i < 4; i += 2) {
          if (box === "margin") {
            marginDelta += jQuery7.css(elem, box + cssExpand[i], true, styles);
          }
          if (!isBorderBox) {
            delta += jQuery7.css(elem, "padding" + cssExpand[i], true, styles);
            if (box !== "padding") {
              delta += jQuery7.css(elem, "border" + cssExpand[i] + "Width", true, styles);
            } else {
              extra += jQuery7.css(elem, "border" + cssExpand[i] + "Width", true, styles);
            }
          } else {
            if (box === "content") {
              delta -= jQuery7.css(elem, "padding" + cssExpand[i], true, styles);
        ...
        css: function(name, value) {
          return access(this, function(elem, name2, value2) {
            ...
            if (Array.isArray(name2)) {
              ...
              len = name2.length;
              for (; i < len; i++) {
                map[name2[i]] = jQuery7.css(elem, name2[i], false, styles);
              }
              return map;
            }
      ...
      jQuery7.fx.tick = function() {
        var timer, i = 0, timers = jQuery7.timers;
        fxNow = Date.now();
      ...
      jQuery7.fn.extend({
        val: function(value) {
          ...
          return this.each(function(i) {
            ...
            if (valueIsFunction) {
              val = value.call(this, i, jQuery7(this).val());
            } else {
              val = value;
            }
            if (val == null) {
      ...
      jQuery7.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function(elem, value) {
              var optionSet, option, options = elem.options, values = jQuery7.makeArray(value), i = options.length;
              while (i--) {
                option = options[i];
      ...
      jQuery7.fn.extend({
        ...
        wrapInner: function(html) {
          if (isFunction(html)) {
            return this.each(function(i) {
              jQuery7(this).wrapInner(html.call(this, i));
            });
          }
          return this.each(function() {
        ...
        wrap: function(html) {
          ...
          return this.each(function(i) {
            jQuery7(this).wrapAll(htmlIsFunction ? html.call(this, i) : html);
          });
        },
      ...
      jQuery7.offset = {
        setOffset: function(elem, options, i) {
          ...
          if (isFunction(options)) {
            options = options.call(elem, i, jQuery7.extend({}, curOffset));
          }
          if (options.top != null) {
        ...
        offset: function(options) {
          if (arguments.length) {
            return options === void 0 ? this : this.each(function(i) {
              jQuery7.offset.setOffset(this, options, i);
            });
          }
...
var DataTable2 = function(selector, options) {
  ...
  this.each(function() {
    ...
    var oSettings = $2.extend(true, {}, DataTable2.models.oSettings, {
    ...
    $2.extend(oClasses, DataTable2.ext.classes, oInit.oClasses);
...
$2.extend(DataTable2.ext.classes, {
...
function _fnCompatOpts(init2) {
  ...
  if (typeof init2.bSort === "object") {
    init2.orderIndicators = init2.bSort.indicators !== void 0 ? init2.bSort.indicators : true;
    init2.orderHandler = init2.bSort.handler !== void 0 ? init2.bSort.handler : true;
    init2.bSort = true;
  } else if (init2.bSort === false) {
    init2.orderIndicators = false;
    init2.orderHandler = false;
  } else if (init2.bSort === true) {
    init2.orderIndicators = true;
    init2.orderHandler = true;
  }
  if (typeof init2.bSortCellsTop === "boolean") {
    init2.titleRow = init2.bSortCellsTop;
  }
...
function _fnAddColumn(oSettings) {
  ...
  searchCols[iCol] = $2.extend({}, DataTable2.models.oSearch, searchCols[iCol]);
}
...
function _fnAddData(settings, dataIn, tr, tds) {
  ...
  var rowModel = $2.extend(true, {}, DataTable2.models.oRow, {
    src: tr ? "dom" : "data",
    idx: rowIdx
  });
    ...
    while (cell) {
      if (cell.nodeName.toUpperCase() == "TD" || cell.nodeName.toUpperCase() == "TH") {
        ...
        if (write) {
          ...
          if (settings.orderIndicators && isHeader && jqCell.filter(":not([data-dt-order=disable])").length !== 0 && jqCell.parent(":not([data-dt-order=disable])").length !== 0 && $2("span.dt-column-order", cell).length === 0) {
            $2("<span>").addClass("dt-column-order").appendTo(cell);
          }
          var headerFooter = isHeader ? "header" : "footer";
          if ($2("span.dt-column-" + headerFooter, cell).length === 0) {
...
function _fnGetWideStrings(settings, colIdx) {
  ...
  if (!column.wideStrings) {
    ...
    for (var i = 0, iLen = settings.aiDisplayMaster.length; i < iLen; i++) {
      ...
      var s = _stripHtml(cellString).replace(/&nbsp;/g, " ");
      collection.push({
        str: s,
        len: s.length
      });
...
function _fnSortFlatten(settings) {
  var i, k, kLen, aSort = [], extSort = DataTable2.ext.type.order, aoColumns = settings.aoColumns, aDataSort, iCol, sType, srcCol, fixed = settings.aaSortingFixed, fixedObj = $2.isPlainObject(fixed), nestedSort = [];
...
function _fnSort(oSettings, col, dir) {
  var i, iLen, aiOrig = [], extSort = DataTable2.ext.type.order, aoData = oSettings.aoData, sortCol, displayMaster = oSettings.aiDisplayMaster, aSort;
...
var __column_header = function(settings, column, row) {
  ...
  if (row !== void 0) {
    ...
    for (var i = 0; i < header.length; i++) {
      if (header[i][column].unique && $2("span.dt-column-title", header[i][column].cell).text()) {
        target = i;
      }
    }
    if (target === null) {
...
DataTable2.isDataTable = function(table) {
  ...
  $2.each(DataTable2.settings, function(i, o) {
...
_api_register("destroy()", function(remove) {
  ...
  return this.iterator("table", function(settings) {
    ...
    $2(jqTable).find("th, td").removeClass(
      $2.map(DataTable2.ext.type.className, function(v) {
        return v;
      }).join(" ")
    );
...
function cleanHeader(node, className) {
  $2(node).find("span.dt-column-order").remove();
  $2(node).find("span.dt-column-title").each(function() {
...
DataTable2.defaults = {
   ...
   */
  "oSearch": $2.extend({}, DataTable2.models.oSearch),
  /**
...
$2.extend(true, DataTable2.ext.renderer, {
  pagingButton: {
...
function _pagingDraw(settings, host, opts) {
  ...
  var plugin = opts.type ? DataTable2.ext.pager[opts.type] : _pagingDynamic, aria = settings.oLanguage.oAria.paginate || {}, start = settings._iDisplayStart, len = settings._iDisplayLength, visRecords = settings.fnRecordsDisplay(), all = len === -1, page = all ? 0 : Math.ceil(start / len), pages = all ? 1 : Math.ceil(visRecords / len), buttons = [], buttonEls = [], buttonsNested = plugin(opts).map(function(val) {
...
$2.fn.dataTable = DataTable2;
DataTable2.$ = $2;
$2.fn.dataTableSettings = DataTable2.settings;
$2.fn.dataTableExt = DataTable2.ext;
$2.fn.DataTable = function(opts) {
  return $2(this).dataTable(opts).api();
};
$2.each(DataTable2, function(prop, val) {
  $2.fn.DataTable[prop] = val;
});
var dataTables_default = DataTable2;

// node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs
var $3 = import_jquery2.default;
$3.extend(true, dataTables_default.defaults, {
  renderer: "bootstrap"
});
$3.extend(true, dataTables_default.ext.classes, {
...
dataTables_default.ext.renderer.pagingButton.bootstrap = function(settings, buttonType, content, active, disabled) {
  ...
  var li = $3("<li>").addClass(btnClasses.join(" "));
  var a = $3("<button>", {
    "class": "page-link",
    role: "link",
    type: "button"
...
dataTables_default.ext.renderer.pagingContainer.bootstrap = function(settings, buttonEls) {
  return $3("<ul/>").addClass("pagination").append(buttonEls);
};
  ...
  */
  ...
  _buildButton: function(config, inCollection, isSplit, inSplit) {
    ...
    if (!config.html) {
      ...
      button = $4("<" + tag + "/>").addClass(dom.className).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(e) {
        e.preventDefault();
      ...
      if (dom.liner.tag) {
        ...
        var liner = $4("<" + lc + "/>").html(text(config.text)).addClass(dom.liner.className);
        if (lc === "a") {
          liner.attr("href", "#");
        }
        if (lc === "a" || lc === "button") {
  ...
  _popover: function(content, hostButton, inOpts) {
    ...
    if (options.sort) {
      ...
      $4(content).append(elements.map(function(v) {
        return v.el;
      }));
    }
    ...
    if (position === "absolute") {
      ...
      if (offsetParent.offset().top + top < $4(window).scrollTop()) {
    ...
    setTimeout(function() {
      closed = false;
      $4("body").on("click.dtb-collection", function(e) {
        if (closed) {
          return;
        }
        var back = $4.fn.addBack ? "addBack" : "andSelf";
        var parent = $4(e.target).parent()[0];
        if (!$4(e.target).parents()[back]().filter(content).length && !$4(parent).hasClass("dt-buttons") || $4(e.target).hasClass("dt-button-background")) {
          close();
        }
...
function enableMouseSelection(dt) {
  ...
  container.on("mousedown.dtSelect", selector, function(e) {
    ...
    if ($6(e.target).closest("div.dt-container")[0] != container2) {
      return;
    }
...
function initCheckboxHeader(dt, headerCheckbox) {
  ...
  dt.columns().iterator("column", function(s, idx) {
    ...
    if (!$6("input", header).length) {
      var input = $6("<input>").attr({
...
function init(ctx) {
  ...
  ctx.aoRowCreatedCallback.push(
    function(row, data, index) {
      ...
      if (d._select_selected || id !== "undefined" && ctx._select_set.includes(id)) {
        ...
        $6(row).addClass(ctx._select.className).find("input." + checkboxClass(true)).prop("checked", true);
      }
  ...
  api.on("destroy.dtSelect", function() {
    ...
    $6("input." + checkboxClass(true), api.table().header()).remove();
...
apiRegisterPlural("rows().select()", "row().select()", function(select) {
  ...
  this.iterator("row", function(ctx, idx) {
    ...
    $6(dtData.nTr).addClass(ctx._select.className);
    ...
    for (var i = 0; i < dtColumns.length; i++) {
      ...
      if (isCheckboxColumn(col)) {
        ...
        if (cells && cells[i]) {
          $6("input." + checkboxClass(true), cells[i]).prop("checked", true);
        }
...
apiRegisterPlural("rows().deselect()", "row().deselect()", function() {
  ...
  this.iterator("row", function(ctx, idx) {
    var dtData = ctx.aoData[idx];
    var dtColumns = ctx.aoColumns;
    $6(dtData.nTr).removeClass(ctx._select.className);
    ...
    for (var i = 0; i < dtColumns.length; i++) {
      ...
      if (isCheckboxColumn(col)) {
        var cells = dtData.anCells;
        if (cells && cells[i]) {
          $6("input." + checkboxClass(true), dtData.anCells[i]).prop("checked", false);
        }
        if (dtData._aSortData !== null) {
          dtData._aSortData[i] = null;
        }
...
$6.extend(dataTables_default.ext.buttons, {
  selected: {
...
$6.extend(true, dataTables_default.defaults.oLanguage, {
  select: {
    aria: {
  ...
  var fn = function(data, type, row, meta) {
    ...
    if (type === "display") {
      ...
      return $6("<input>").attr({
        ...
        e.preventDefault();
        this.checked = $6(this).closest("tr").hasClass("selected");
      })[0];
    } else if (type === "type") {
...
dataTables_default.ext.order["select-checkbox"] = function(settings, col) {
  return this.api().column(col, { order: "index" }).nodes().map(function(td) {
    if (settings._select.items === "row") {
      return $6(td).parent().hasClass(settings._select.className).toString();
    } else if (settings._select.items === "cell") {
      return $6(td).hasClass(settings._select.className).toString();
    }
    return false;
  });
};
$6.fn.DataTable.select = dataTables_default.select;
$6(document).on("i18n.dt.dtSelect preInit.dt.dtSelect", function(e, ctx) {
  if (e.namespace !== "dt") {
    return;
  }
  dataTables_default.select.init(new dataTables_default.Api(ctx));
...
document.addEventListener("DOMContentLoaded", function() {
  DataTable.ext.buttons.duplicate = {
    name: "duplicate",
    extend: "selected",
...
document.addEventListener("DOMContentLoaded", function() {
  DataTable.ext.buttons.forceDeleteSingle = {
...
document.addEventListener("DOMContentLoaded", function() {
  DataTable.ext.buttons.ajaxBatch = {
    ...
    action: function(e, dt, node, config) {
      ...
      if (config.hasOwnProperty("confirmation")) {
        const confirmation = config.confirmation.replaceAll("_COUNT_", selected.length).replaceAll("_PLURAL_", selected.length > 1 ? "s" : "");
